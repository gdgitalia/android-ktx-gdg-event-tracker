...
class TalkRecyclerAdapter(
    options: FirestoreRecyclerOptions<Talk>,
    private val navigator: TalkItemNavigator
) : FirestoreRecyclerAdapter<Talk, TalkHolder>(options) {
    ...
    override fun onBindViewHolder(holder: TalkHolder, position: Int, model: Talk) {
        ...
        val countryPath =
            "https://raw.githubusercontent.com/madebybowtie/FlagKit/master/Assets/PNG/${model.country}.png"
